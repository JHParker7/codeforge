...
import (
	"bytes"
	"codeforge/src/gatekeeper/graph/model"
	"context"
	"embed"
	"errors"
	"fmt"
...
func (ec *executionContext) field_Mutation_createTodo_args(ctx context.Context, rawArgs map[string]any) (map[string]any, error) {
	var err error
	args := map[string]any{}
	arg0, err := graphql.ProcessArgField(ctx, rawArgs, "input", ec.unmarshalNNewTodo2codeforgeᚋsrcᚋgatekeeperᚋgraphᚋmodelᚐNewTodo)
	if err != nil {
		return nil, err
	}
	args["input"] = arg0
...
func (ec *executionContext) _Mutation_createTodo(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		nil,
		ec.marshalNTodo2ᚖcodeforgeᚋsrcᚋgatekeeperᚋgraphᚋmodelᚐTodo,
		true,
		true,
	)
}
...
func (ec *executionContext) _Query_todos(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		nil,
		ec.marshalNTodo2ᚕᚖcodeforgeᚋsrcᚋgatekeeperᚋgraphᚋmodelᚐTodoᚄ,
		true,
		true,
	)
}
...
func (ec *executionContext) _Todo_user(ctx context.Context, field graphql.CollectedField, obj *model.Todo) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		nil,
		ec.marshalNUser2ᚖcodeforgeᚋsrcᚋgatekeeperᚋgraphᚋmodelᚐUser,
		true,
		true,
	)
}
...
func (ec *executionContext) unmarshalNNewTodo2codeforgeᚋsrcᚋgatekeeperᚋgraphᚋmodelᚐNewTodo(ctx context.Context, v any) (model.NewTodo, error) {
...
func (ec *executionContext) marshalNTodo2codeforgeᚋsrcᚋgatekeeperᚋgraphᚋmodelᚐTodo(ctx context.Context, sel ast.SelectionSet, v model.Todo) graphql.Marshaler {
	return ec._Todo(ctx, sel, &v)
}

func (ec *executionContext) marshalNTodo2ᚕᚖcodeforgeᚋsrcᚋgatekeeperᚋgraphᚋmodelᚐTodoᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.Todo) graphql.Marshaler {
	ret := graphql.MarshalSliceConcurrently(ctx, len(v), 0, false, func(ctx context.Context, i int) graphql.Marshaler {
		fc := graphql.GetFieldContext(ctx)
		fc.Result = &v[i]
		return ec.marshalNTodo2ᚖcodeforgeᚋsrcᚋgatekeeperᚋgraphᚋmodelᚐTodo(ctx, sel, v[i])
	})
...
func (ec *executionContext) marshalNTodo2ᚖcodeforgeᚋsrcᚋgatekeeperᚋgraphᚋmodelᚐTodo(ctx context.Context, sel ast.SelectionSet, v *model.Todo) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			graphql.AddErrorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) marshalNUser2ᚖcodeforgeᚋsrcᚋgatekeeperᚋgraphᚋmodelᚐUser(ctx context.Context, sel ast.SelectionSet, v *model.User) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			graphql.AddErrorf(ctx, "the requested element is null which the schema does not allow")
		}
